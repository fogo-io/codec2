...
static const float codes3[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp5.txt */
static const float codes4[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp6.txt */
static const float codes5[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp7.txt */
static const float codes6[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp8.txt */
static const float codes7[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp9.txt */
static const float codes8[] = {
  ...
  /* /media/psf/Home/git/codec2/src/codebook/lsp10.txt */
